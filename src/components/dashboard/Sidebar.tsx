...
export function Sidebar({ className }: SidebarProps) {
  ...
  return (
    <div className={cn("pb-12 bg-card/50", className)}>
      <div className="space-y-4 py-4 flex flex-col h-full">
        ...
        <div className="px-3 mt-auto space-y-1">
          <Link
            ...
            className="text-sm group flex p-3 w-full justify-start font-medium cursor-pointer text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-lg transition"
          >
            <div className="flex items-center flex-1">
          ...
          <div className="mt-4 px-3 flex items-center gap-3 py-3 border-t">
            <UserButton />
